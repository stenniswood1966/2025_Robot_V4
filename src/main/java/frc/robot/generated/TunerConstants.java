...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(80).withKI(0).withKD(0.5)//kp=100
    ...
    public static final CANBus kCANBus = new CANBus("Flurb_Drive", "./logs/example.hoot");

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.47);//5.96
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.212890625);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.256103515625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.3876953125);
